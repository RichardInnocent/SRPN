...
public class MultiplicationOperatorTest {
  ...
  public void testMultiplicationOfLargePositiveValuesTruncates() {
    assertEquals(Integer.MAX_VALUE, OPERATOR.apply(Integer.MAX_VALUE, Integer.MAX_VALUE), DELTA);
  }

  @Test
  public void testMultiplicationOfLargeNegativeValuesTruncates() {
    assertEquals(Integer.MAX_VALUE, OPERATOR.apply(Integer.MIN_VALUE, Integer.MIN_VALUE), DELTA);
  }

  @Test
  public void testMultiplicationOfLargePositiveNumberAndLargeNegativeNumberTruncates() {
    assertEquals(Integer.MIN_VALUE, OPERATOR.apply(Integer.MAX_VALUE, Integer.MIN_VALUE), DELTA);
  }
